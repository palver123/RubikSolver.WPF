...
namespace Rubik01.AI
{
    internal static class Solver
    {
        ...
        public static bool Solve(Cube cube)
        {
            ...
            var secondRowEdges = new Cubicle[] {
                    cube.GetCubicleByCenter(solvedCube.cubicles[1, 0, 0].center),
                    cube.GetCubicleByCenter(solvedCube.cubicles[1, 0, 2].center),
                    cube.GetCubicleByCenter(solvedCube.cubicles[1, 2, 0].center),
                    cube.GetCubicleByCenter(solvedCube.cubicles[1, 2, 2].center)
                };
            ...
            if (isSolved(cube)) return true;
            counter = 0;
            var bottomCorners = new Cubicle[] {
                    cube.GetCubicleByCenter(solvedCube.cubicles[0, 0, 0].center),
                    cube.GetCubicleByCenter(solvedCube.cubicles[0, 0, 2].center),
                    cube.GetCubicleByCenter(solvedCube.cubicles[0, 2, 0].center),
                    cube.GetCubicleByCenter(solvedCube.cubicles[0, 2, 2].center)
                };
            ...
            while (counter < 3 && (!bottomCornerSolved[0] || !bottomCornerSolved[1] || !bottomCornerSolved[2] || !bottomCornerSolved[3]))
            {
                ...
                for (var j = 0; j < 6; j++)
                {
                    if ((bottomCorners[0].facets[j].normal == solvedCube.cubicles[0, 0, 0].facets[j].normal) && (bottomCorners[0].facets[j].color != solvedCube.cubicles[0, 0, 0].facets[j].color)) bottomCornerSolved[0] = false;
                    if ((bottomCorners[1].facets[j].normal == solvedCube.cubicles[0, 0, 2].facets[j].normal) && (bottomCorners[1].facets[j].color != solvedCube.cubicles[0, 0, 2].facets[j].color)) bottomCornerSolved[1] = false;
                    if ((bottomCorners[2].facets[j].normal == solvedCube.cubicles[0, 2, 0].facets[j].normal) && (bottomCorners[2].facets[j].color != solvedCube.cubicles[0, 2, 0].facets[j].color)) bottomCornerSolved[2] = false;
                    if ((bottomCorners[3].facets[j].normal == solvedCube.cubicles[0, 2, 2].facets[j].normal) && (bottomCorners[3].facets[j].color != solvedCube.cubicles[0, 2, 2].facets[j].color)) bottomCornerSolved[3] = false;
                }
        ...
        {
            foreach (var c1 in solvedCube.cubicles)
            {
